...
import net.mcreator.roxdev.client.renderer.RoboFlameArmorRenderer;

import java.util.function.Consumer;
import java.util.List;

public class RoboFlameItem extends ArmorItem implements GeoItem {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	public String animationprocedure = "empty";

	public RoboFlameItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForType(ArmorItem.Type type) {
				return new int[]{10, 30, 40, 15}[type.getSlot().getIndex()];
			}
		...
		consumer.accept(new IClientItemExtensions() {
			...
			public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
				if (this.renderer == null)
					this.renderer = new RoboFlameArmorRenderer();
