...
import net.mcreator.roxdev.item.renderer.SupersonicPantsItemRenderer;
...
public class SupersonicPantsItem extends Item implements GeoItem {
	...
	private void equipArmor(Player player, Level level) {
		...
		player.setItemSlot(EquipmentSlot.LEGS, new ItemStack(RoxDevModItems.BIO_PANTS_LEGGINGS.get()));
