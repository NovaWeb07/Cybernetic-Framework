...
import net.mcreator.roxdev.entity.CannonIceProjectileEntity;
import net.mcreator.roxdev.RoxDevMod;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class RoxDevModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, RoxDevMod.MODID);
