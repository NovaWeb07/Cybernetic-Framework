package net.mcreator.roxdev.client;
...
@OnlyIn(Dist.CLIENT)
@Mod.EventBusSubscriber(modid = RoxDevMod.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
public class CyberHeartHudOverlay {

    private static final ResourceLocation CYBER_HEART_TEX =
            new ResourceLocation(RoxDevMod.MODID, "textures/gui/cyber_heart.png");
