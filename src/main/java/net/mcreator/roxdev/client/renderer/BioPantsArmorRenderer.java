...
import net.mcreator.roxdev.item.model.BioPantsModel;
import net.mcreator.roxdev.item.BioPantsItem;

public class BioPantsArmorRenderer extends GeoArmorRenderer<BioPantsItem> {
	public BioPantsArmorRenderer() {
		super(new BioPantsModel());
	...
	@Override
	public RenderType getRenderType(BioPantsItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
