package net.mcreator.roxdev.event;
...
import net.mcreator.roxdev.network.CyberHeartNetworking;

@Mod.EventBusSubscriber(modid = RoxDevMod.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE)
