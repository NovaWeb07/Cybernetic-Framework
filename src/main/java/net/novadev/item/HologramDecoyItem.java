...
import net.novadev.item.renderer.HologramDecoyItemRenderer;
...
public class HologramDecoyItem extends Item implements GeoItem {
	...
	public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
		...
		if (!level.isClientSide() && level instanceof ServerLevel serverLevel) {
			...
			for (int i = 0; i < 10; i++) {
				HologramCloneEntity clone = new HologramCloneEntity(NovaDevModEntities.HOLOGRAM_CLONE.get(), level);
